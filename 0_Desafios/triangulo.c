// o seguinte codigo foi feito pra ser o mais complexo possivel pois estou
// aprendendo ;) Desnesseçariamente comprexo pra caraio mas ficou legal ;)
// totalmente overkill
...
void area_perimetro_equilatero(float numeros[2], float lado1, float lado2,
                               float lado3) {
    float base, altura;
...
void area_perimetro_isosceles(float numeros[2], float lado1, float lado2,
                              float lado3) {
    float base, altura;
    float aux;
...
void area_perimetro_escaleno(float numeros[2], float lado1, float lado2,
                             float lado3) {
    float base, altura;
    float aux;
